  ...
  return (
    <main className="methods-page">
      ...
      <section className="methods-classes">
        ...
        <Link
          to="/semestre/5/metodos-de-investigacion/clase/14-septiembre"
          className="methods-class-card"
        >
          <div className="methods-date">
            <strong>XIV</strong>
          ...
          <div className="methods-class-copy">
            <span>Séptima clase · Problema y método</span>
            <h3>Del concepto al problema de investigación</h3>
            <p>
              Concepto, referente teórico, ramas y categorías, tema específico,
              problemática, problema, metodología, fenomenología y dialéctica
              socrático-platónica.
            </p>
          </div>
          <div className="methods-enter"><span>Abrir folio</span><b>↗</b></div>
